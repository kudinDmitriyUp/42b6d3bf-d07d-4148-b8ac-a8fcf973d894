...
export const metadata: Metadata = {
  title: "CucumberScale - Visual Size Comparison Tool",
  description: "Compare cucumber sizes to everyday objects instantly. Perfect for educators, gardeners, and visual learners. See how big a cucumber really is!",
  keywords: "cucumber size, visual comparison, educational tool, gardening, measurement, size reference",
  openGraph: {
    title: "CucumberScale - Visual Size Comparison Tool",
    description: "Compare cucumber sizes to everyday objects instantly. Perfect for educators, gardeners, and visual learners.",
    siteName: "CucumberScale",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35Znpd3ByEERAsUQupIuQAIsKDh/uploaded-1763338645742-qu7vunqk.png",
      alt: "Cucumber size comparison with everyday objects"
    }]
  },
  twitter: {
    ...
    title: "CucumberScale - Visual Size Comparison Tool",
    description: "Compare cucumber sizes to everyday objects instantly. Perfect for educators, gardeners, and visual learners.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35Znpd3ByEERAsUQupIuQAIsKDh/uploaded-1763338645742-qu7vunqk.png"]
  },
  robots: {
    index: true,
    follow: true
